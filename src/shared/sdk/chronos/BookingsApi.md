...
------------- | ------------- | -------------
[**cancelBooking**](BookingsApi.md#cancelBooking) | **PATCH** /bookings/{id}/cancel | Cancel a booking
...
import type { BookingsApiCancelBookingRequest } from '';

const configuration = createConfiguration();
const apiInstance = new BookingsApi(configuration);

const request: BookingsApiCancelBookingRequest = {
    // Booking ID
  id: 1,
};

const data = await apiInstance.cancelBooking(request);
...
# **getBookingsByDate**
> Array<Booking> getBookingsByDate()
...
# **getBookingsByStatus**
> Array<Booking> getBookingsByStatus()
...
# **getBookingsByUser**
> Array<Booking> getBookingsByUser()
...
# **getUpcomingBookings**
> Array<Booking> getUpcomingBookings()
...
# **updateBooking**
> Booking updateBooking(updateBooking)
