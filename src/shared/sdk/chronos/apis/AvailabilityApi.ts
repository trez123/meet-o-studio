...
export class AvailabilityApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createAvailability(newAvailability: NewAvailability, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'newAvailability' is not null or undefined
        if (newAvailability === null || newAvailability === undefined) {
            throw new RequiredError("AvailabilityApi", "createAvailability", "newAvailability");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(newAvailability, "NewAvailability", ""),
            contentType
        );
