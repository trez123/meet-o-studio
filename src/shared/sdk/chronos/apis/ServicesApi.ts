...
export class ServicesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param newService 
     */
    public async createService(newService: NewService, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'newService' is not null or undefined
        if (newService === null || newService === undefined) {
            throw new RequiredError("ServicesApi", "createService", "newService");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(newService, "NewService", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
     ...
     * @param updateService 
     */
    public async updateService(id: number, updateService: UpdateService, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'updateService' is not null or undefined
        if (updateService === null || updateService === undefined) {
            throw new RequiredError("ServicesApi", "updateService", "updateService");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(updateService, "UpdateService", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class ServicesApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createServiceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Service >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getActiveServicesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<Service> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getAllServicesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<Service> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<Service> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getServiceByIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Service >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Service = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getServiceByNameWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Service >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Service = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getServicesByDurationWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<Service> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<Service> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getServicesByPriceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<Service> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<Service> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchServicesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<Service> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<Service> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async toggleServiceStatusWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Service >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Service = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
