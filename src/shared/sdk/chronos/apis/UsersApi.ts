...
export class UsersApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async changeUserPassword(id: number, changePasswordRequest: ChangePasswordRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("UsersApi", "changeUserPassword", "id");
        }


        // verify required parameter 'changePasswordRequest' is not null or undefined
        if (changePasswordRequest === null || changePasswordRequest === undefined) {
            throw new RequiredError("UsersApi", "changeUserPassword", "changePasswordRequest");
        }


        // Path Params
        const localVarPath = '/users/{id}/change-password'
     ...
     * @param newUser 
     */
    public async createUser(newUser: NewUser, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'newUser' is not null or undefined
        if (newUser === null || newUser === undefined) {
            throw new RequiredError("UsersApi", "createUser", "newUser");
        }
    ...
    public async deleteUser(id: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("UsersApi", "deleteUser", "id");
        }
    ...
    public async getUserByEmail(email: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (email === null || email === undefined) {
            throw new RequiredError("UsersApi", "getUserByEmail", "email");
        }
    ...
    public async getUserById(id: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("UsersApi", "getUserById", "id");
        }
     ...
     */
    public async getUsersByRole(role: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'role' is not null or undefined
        if (role === null || role === undefined) {
            throw new RequiredError("UsersApi", "getUsersByRole", "role");
        }
     ...
     * @param updateUser 
     */
    public async updateUser(id: number, updateUser: UpdateUser, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (updateUser === null || updateUser === undefined) {
            throw new RequiredError("UsersApi", "updateUser", "updateUser");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(updateUser, "UpdateUser", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class UsersApiResponseProcessor {
     ...
     */
     public async changeUserPasswordWithHttpInfo(response: ResponseContext): Promise<HttpInfo<User >> {
     ...
     */
     public async createUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<User >> {
        ...
        if (isCodeInRange("409", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Email already exists", undefined, response.headers);
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
        ...
        if (isCodeInRange("409", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Cannot delete user with existing bookings", undefined, response.headers);
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUserByEmailWithHttpInfo(response: ResponseContext): Promise<HttpInfo<User >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: User = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUserByIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<User >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: User = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getUsersByRole
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getUsersByRoleWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<User> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<User> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
