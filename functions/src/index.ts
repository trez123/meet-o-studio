                ...
                <tbody>
                  <tr style="width: 100%">
                    <td>
                      ...
                      <div style="font-weight: normal; padding: 0px 24px 16px 24px">
                        Thank you for contacting Meet Studio.Co! We have received your inquiry and appreciate your interest in our services.
                      </div>
                      <div style="font-weight: normal; padding: 0px 24px 16px 24px">
                         Our team is currently reviewing your request and will get back to you shortly with more information. If you have any additional details or questions in the meantime, please feel free to reply to this email.
                      </div>
                      <div style="font-weight: normal; padding: 16px 24px 16px 24px">
                        We look forward to working with you and helping to bring your vision to life!
                      </div>
